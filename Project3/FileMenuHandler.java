...
/**
 * the actionPerformed choose a file and displays the text file
 * in addition, it also has certain options like Open and Quit. 
 */
...
/**
 * the private method loadRomanNumeralsFromFile reads the selected file and puts them in an unsorted and sorted list
